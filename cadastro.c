...
int main()
{
    ...
    // --------Carta 01--------
    char estado1[5];                              // recebe a letra referente ao estado // alterei de char para string para receber mais de uma letra
    char codigo1[10];                             // recebe o codigo da carta
    ...
    char estado2[5];                              // recebe a letra referente ao estado // alterei de char para string para receber mais de uma letra
    char codigo2[10];                             // recebe o codigo da carta
    char cidade2[50];                             // recebe o nome da cidade
    unsigned long int populacao2;                 // recebe o numero da populacao trocado para unsigned long int era int
    ...
    printf("Estado: \n");   // entrada do estado
    scanf(" %s", &estado1); // troquei %c por %s para receber mais de uma letra
    ...
    scanf(" %lu", &populacao1); // troquei %d por %lu para unsigned long int
    ...
    printf("Estado:\n");    // entrada do estado
    scanf(" %s", &estado2); // troquei %c por %s para receber mais de uma letra
    ...
    printf("População:\n");     // entrada da população
    scanf(" %lu", &populacao2); // troquei %d por %lu para unsigned long int
    ...
    printf("Estado: %s\n", estado1);                                // estado da carta // troquei %c por %s para receber mais de uma letra
    printf("Código: %s\n", codigo1);                                // codigo da carta
    printf("Nome da Cidade: %s\n", cidade1);                        // nome da cidade
    printf("População: %lu\n", populacao1);                         // população // troquei %d por %lu para unsigned long int
    ...
    printf("Estado: %s\n", estado2);                                // estado da carta // troquei %c por %s para receber mais de uma letra
    printf("Código: %s\n", codigo2);                                // codigo da carta
    printf("Nome da Cidade: %s\n", cidade2);                        // nome da cidade
    printf("População: %lu\n", populacao2);                         // população // troquei %d por %lu para unsigned long int
    ...
    printf("População: Carta A venceu (%d)\n", populacao1 > populacao2);                       // compara e exibe o resultado da comparação de população
    printf("Área: Carta A venceu (%d)\n", area1 > area2);                                      // compara e exibe o resultado da comparação de área
    printf("PIB: Carta A venceu (%d)\n", pib1 > pib2);                                         // compara e exibe o resultado da comparação de pib
    printf("Pontos Turísticos: Carta A venceu (%d)\n", pontosturisticos1 > pontosturisticos2); // compara e exibe o resultado da comparação de pontos turísticos
    printf("Densidade Populacional: Carta A venceu (%d)\n", densidade1 < densidade2);          // compara e exibe o resultado da comparação de densidade populacional
    printf("PIB per Capita: Carta A venceu (%d)\n", pibpercapita1 > pibpercapita2);            // compara e exibe o resultado da comparação de pib per capita
    printf("Super Poder: Carta A venceu (%d)\n", superPoder1 > superPoder2);                   // compara e exibe o resultado da comparação de super poder
